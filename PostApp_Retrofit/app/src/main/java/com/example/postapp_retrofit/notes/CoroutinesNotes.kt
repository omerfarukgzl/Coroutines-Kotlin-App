...
Coroutine'ların durumunu kontrol etmek için kullanılır.
    ...
    println("Job : ${job.isCancelled}")
    // Job : false
    // coroutine iptal edilmedi.

    job.cancel()
    // coroutine iptal edildi.

   -->> job.invokeOnCompletion {
          job bittiğinde yapılacak işlemler
         }
...
Coroutine'ların çalışacağı thread'i değiştirmek için kullanılır.
